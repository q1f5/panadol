...
return "📛*│* هذا الامر يخص {المدير,المنشئ,المطور} فقط  /n 🚶🏻‍♀️"
end
...
text = [[🧘🏻‍♀️╿ولكم نورت انا بوت اسمي    []]..redis:get(max..':NameBot:')..[[] يقلبي انت/ي 🤍
 اختصاصي حمايه المجموعات 🌟
 من تكرار والسبام والتوجيه والخ…✨🛡
 
لتفعيلي اتبع الخطوات …↓😴🖤:
 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه  تفعيل  ويستطيع  المنشئ او المشرفين بتفعيلي فقط 🧚🏻‍♀️✨.
⚠️   تنبية لتفعيل البوت شرط التفعيل هو 30 عضو فقط   ⚠️
ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
...
sendMsg(msg.chat_id_,msg.id_,'😢│تف عليكم من يقعد عندكم 😒🔪 زعلت 😭💔')
...
return sendMsg(msg.chat_id_,msg.id_," اعشقك يا روحي انت/ي 🌞♥️")
